...
public class HospitalServiceImpl implements HospitalService {
    ...
    @Override
    public Map<String, Object> submitOrder(Map<String, Object> paramMap) throws ParseException {
        ...
        String quitTime = (String)paramMap.get("quitTime");
        ...
        if(availableNumber > 0) {
            ...
            String fetchTime = "0".equals(reserveDate) ? " 09:30 前" : " 14:00 前";
            orderInfo.setFetchTime(reserveTime + fetchTime);
            orderInfo.setFetchAddress("一楼"+new Random().nextInt(20) +"号窗口");
            //默认 未支付
            orderInfo.setOrderStatus(0);
            Date date =  new DateFormatter("EEE MMM dd HH:mm:ss zzz yyyy").parse(quitTime, Locale.US);
            orderInfo.setQuitTime(date);
            ...
            //取号时间
            resultMap.put("fetchTime", reserveDate + " 09:00 前");;
            //取号地址
            resultMap.put("fetchAddress", "一层"+(int)(Math.random()*40+100)+"窗口");;
            //排班可预约数
